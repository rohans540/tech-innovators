...
import { neurawaveServices, neurawaveServicesIcons } from "../constants";
...
const Services = () => {
    const title = "Generative AI made for creators";
    const text = "Neurawave unlocks the potential of AI powered applications";
  return (
    <Section id='features'>
            ...
            <div className="relative">
                ...
                border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
                    ...
                    <div className="relative z-1 max-w-[17rem] ml-auto">
                        ...
                        <ul className="body-2">
                            {neurawaveServices.map((item, index) => (
                    ...
                    rounded-3xl overflow-hidden ">
                        ...
                        p-8 bg-gradient-to-b from-n-8/0 to-n-8/90 lg:p-15">
                            ...
                            <p className="body-2 mb-[3rem] text-n-3">
                                Automatically enhances your photos using your AI app&apos;s photo editing feture. Try it now!
                            </p>
                        </div>
                        <PhotoChatMessage />
                    </div>
                    <div className="p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem]">
                        <div className="py-12 px-4 xl:px-8">
                            ...
                            <ul className="flex items-center justify-between">
                                {neurawaveServicesIcons.map((item, index) => 
                                (
                                    <li key={index} className={`rounded-xl flex items-center justify-center 
                                    ${index === 2 ? 'w-[3rem] h-[3rem] p-0.25 bg-conic-gradient rounded-2xl md:w-[4.5rem] md:[4,5rem]' 
